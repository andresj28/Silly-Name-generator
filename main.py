...
flag = True
options = ['abismo','and',"verbAndVerb"]
options_verbs = ['aprendiendo','atrévete']
...
def verbAndVerb():
    choosen = random.choice(options_verbs)
    verb1 = random.choice(verbs)
    novela = f"{choosen.title()} a {verb1}"
    return novela
...
while flag:
    ...
    elif choosen == 'verbAndVerb':
        novela_title = verbAndVerb()
